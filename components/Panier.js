    ...
    <div className={styles.main} style={props.style}>
      ...
      >
        ...
        {basketValue.length === 0 ? (
          ...
          [
            <>
              <div className={styles.sumProductContainer}>
                <div className={styles.sumUpContainer}>
                  <div className={styles.text}>
              ...
              <div className={styles.totalPayContainer}>
                <div className={styles.deliveryContainer}>
                  <div className={styles.switchContainer}>
                    <div className={styles.tinyText}>Click & collect</div>
                  ...
                  <div className={styles.switchContainer}>
                    <div className={styles.tinyText}>Livraison</div>
                    <div className={styles.toggleContainer}>
                      <label className={styles.switch}>
                        <input
                          type="checkbox"
